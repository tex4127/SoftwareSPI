...
typedef enum
{
    SOFTSPI_CLOCK_DIV2   = 0x02,
    SOFTSPI_CLOCK_DIV4   = 0x04,
    SOFTSPI_CLOCK_DIV8   = 0x08,
    SOFTSPI_CLOCK_DIV16  = 0x10,
    SOFTSPI_CLOCK_DIV32  = 0x20,
    SOFTSPI_CLOCK_DIV64  = 0x40,
    SOFTSPI_CLOCK_DIV128 = 0x80
} SPIClockDiv_e;
